...
<div class="container my-4 content">
    <form class="row g-1 form-input" name="form-order" id="form-order"
        ...
        <div class="col-xl-3 col-md-12 col-sm-12 ">
            <div class="form-floating mb-3">
                ...
                <label for="floatingInput" style="color:black">Ingrese nombre del orden</label>
            </div>
        </div>
        ...
        <?php if (isset($vars['order-updated'])) { ?>
            <div class="col-xl-3 col-md-6 col-sm-12 mb-3">
                <div class="alert alert-success" role="alert">
                    ...
                    Se actualizó correctamente el orden<br>
                    Con el nombre de:
                    <?php echo $vars['order-updated']; ?>
                </div>
            </div>
            <?php
        } ?>
