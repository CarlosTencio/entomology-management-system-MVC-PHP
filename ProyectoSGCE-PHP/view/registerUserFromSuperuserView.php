...
<div class="container my-4 content">
    <form class="row g-3 form-input" method="post" action="?controller=User&action=registerUserAdmins">
                ...
                <div class="col-12 mb-3 d-flex justify-content-center">
                    <div class="col-5 mb-3">
                        <div class="alert alert-success" role="alert">
                            ...
                            Se registró correctamente el usuario<br>
                            Con nombre:
            ...
            <div class="col-12 mb-3 d-flex justify-content-center">
                <div class="col-3 mb-3" id="div-order">
                    ...
                    <input class="form-control is-invalid" id="password" name="password" type="text"
                        oninput="validateEmptyPassword(this,'password-feed')" required disabled>
                ...
                <div class="p-3 bg-success bg-opacity-10 border border-dark  rounded" id="div-checks">
                    <div class=col-12>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="role" id="professorRadio" value="1"
                                checked>
