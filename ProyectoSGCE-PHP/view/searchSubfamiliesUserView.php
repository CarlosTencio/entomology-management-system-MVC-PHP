...
<div class="container my-4 content">
    <form name="form-order" id="form-order" class="row g-1 form-input"
        action="?controller=Subfamily&action=ListSubfamiliesAsc" method="post" class="form-inline">
        ...
        <div class="col-12 d-flex">
            <div class="col-xl-3 col-md-4 col-sm-6 mx-1">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="subfamily" name="subfamily" placeholder="subfamily">
    ...
    <div class="col-xs-1 d-inline-block">
        <form action="?controller=Subfamily&action=ListSubfamiliesAsc" method="post" class="form-inline">
            <input type="text" name="subfamily" id="subfamily" value="<?php echo $vars['name']; ?>" hidden>
            <input type="submit" class="btn btn-secondary" name="asc" value="ASC">
        </form>
    </div>
    <div class="col-xs-1 d-inline-block">
        <form action="?controller=Subfamily&action=ListSubfamiliesDesc" method="post" class="form-inline">
            <input type="text" name="subfamily" id="subfamily" value="<?php echo $vars['name']; ?>" hidden>
    ...
    <?php if ($vars['lista'] == null) {
            ...
            <table class="table" id="resultsTable">
                <thead>
                <tr>
                        <th style="color:aliceblue">Nombre de subfamilia</th>
