                        ...
                        <tr>
                            ...
                            <td style="color:aliceblue">
                                <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                    ...
                                    $('#id_subfamily<?php echo $count; ?>').val() ,$('#name<?php echo $count; ?>').val())">Actualizar
                                </button>
                            </td>
                        </tr>
                        <?php
                    ...
                    <div class="col-12 mb-3 d-flex justify-content-center">
                        <div class="col-6 mb-3" id="">
                            ...
                            <input class="form-control is-valid" id="name-family" name="name-family"
                                list="list-families" type="text" oninput="findFamilyModal();validateRegisteredSubfamilyForUpdate(document.getElementById('name-subfamily-modal'),'name-feed')" disabled>
                            <div class="valid-feedback" id="family-feed">
                                Debe cambiar el orden primero
                            </div>
