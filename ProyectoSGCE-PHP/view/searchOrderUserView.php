...
<div class="container my-4 content">
    <form name="form-order" id="form-order" class="row g-1 form-input" action="?controller=Order&action=ListOrdersAsc"
        method="post" class="form-inline">
        <div class="col-12 mb-3 my-4 text-center">
            <h2 class="title">Buscar Orden</h2>
    ...
    <form action="?controller=Order&action=ListOrdersAsc" method="post" class="form-inline">
        <input type="text" name="order" id="order" value="<?php echo $vars['name']; ?>" hidden>
        <input type="submit" class="btn btn-secondary" name="asc" value="ASC">
    </form>
</div>
<div class="col-xs-1 d-inline-block">
    <form action="?controller=Order&action=ListOrdersDesc" method="post" class="form-inline">
        <input type="text" name="order" id="order" value="<?php echo $vars['name']; ?>" hidden>
            ...
            <table class="table" id="resultsTable">
                <thead>
                    <tr>
                        ...
                        <th style="color:aliceblue">Familias</th>
