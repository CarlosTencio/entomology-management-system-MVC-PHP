...
<body>
	<header class="container-fluid">
		<div class="container">
			...
			<h2 class="title">Módulo Administrativo General</h2>
						...
						<div class="offcanvas-body">
							<ul class="navbar-nav flex-grow-1 pe-3">
								...
								<li class="nav-item dropdown  ">
									...
									<ul class="dropdown-menu">
										<li><a class="dropdown-item"
												...
												Usuario</a></li>
										<li><a class="dropdown-item"
												href="?controller=User&action=showRegisterAdmin">Registrar
												Administrador</a></li>
										<li><a class="dropdown-item" href="?controller=User&action=showManageUser">Ver
												Usuarios</a></li>
										<li><a class="dropdown-item"
								...
								<li class="nav-item dropdown">
									...
									<ul class="dropdown-menu">
										<li><a class="dropdown-item"
												href="?controller=Gender&action=showSearchGenderSpeciesForUpdate">Especimen por
												Género/Especie</a></li>
										<li><a class="dropdown-item"
												href="?controller=Plant&action=showSearchPlantForUpdate">Planta hospedadora</a>
										</li>
										<li><a class="dropdown-item"
